        ...
        <div className="bg-[#1E293B] border border-slate-700 rounded-2xl p-8 sm:p-12 lg:p-16">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-slate-400 leading-relaxed mb-8">
              Tell us about your warehouse operations and requirements. Our
              team will arrange a personalized demonstration of Acrely WMS.
            </p>

            {/* Book Demo CTA */}
            <Link
              to="/book-demo"
              className="inline-flex items-center justify-center gap-2 px-7 py-4 bg-[#1E40AF] hover:bg-[#2563EB] text-white font-bold rounded-lg transition-colors shadow-sm"
            >
