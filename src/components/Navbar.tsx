...
export const Navbar: React.FC = () => {
  ...
  const [openMobileSections, setOpenMobileSections] =
    useState<Record<DropdownKey, boolean>>({
      product: true,
      solutions: true,
      resources: true,
      company: true,
  ...
  const navGroups: NavGroup[] = [
    {
      ...
      items: [
        {
          label: 'Explore the Platform (Beta)',
          path: 'https://demo.acrelywms.com',
          description: 'See how Acrely WMS works.',
          icon: BookOpenText,
        },
        {
          label: 'Features',
          path: '/features',
          description: 'Explore warehouse management capabilities.',
          icon: Layers,
        },
        {
          label: 'Pricing',
          path: '/pricing',
          description: 'View Acrely WMS plans.',
          icon: PackageCheck,
        },
        {
          label: 'Integrations',
          path: '/integrations',
          description:
            'Connect Acrely with your existing systems.',
          icon: Workflow,
        },
        {
          label: 'Security',
          path: '/security',
          description:
            'Learn how Acrely approaches platform and data security.',
          icon: ShieldCheck,
        },
      ],
    },
      ...
      items: [
        {
          ...
          description:
            'Maintain real-time stock visibility across your operations.',
          icon: Boxes,
        },
        {
          label: 'Warehouse Operations',
          path: '/features/warehouse-command-center',
          description:
            'Give managers one view of day-to-day execution.',
          icon: Workflow,
        },
        {
          label: '3PL',
        ...
        },
        {
          ...
          path: '/features/multi-warehouse-multi-client',
          description:
            'Scale operations across locations with unified control.',
          icon: Layers,
        },
      ],
    },
      ...
      items: [
        {
          ...
          path: '/documentation',
          description:
            'Explore setup guides, workflows, and platform references.',
          icon: BookOpenText,
        },
        {
          ...
          path: '/implementation',
          description:
            'Plan a smooth rollout and onboarding timeline.',
          icon: PackageCheck,
        },
        {
          label: 'Download',
          path: '/download',
          description: 'Access materials and release details.',
          icon: Download,
        },
      ],
    },
      ...
      items: [
        {
          label: 'About Us',
          path: '/about',
          description: 'Learn more about Acrely and our mission.',
          icon: Building2,
        },
        {
          label: 'Careers',
          path: '/careers',
          description: 'Explore opportunities to join the team.',
        ...
        },
        {
          ...
          path: '/contact',
          description:
            'Talk with our team about your warehouse needs.',
          icon: PhoneCall,
        },
      ],
    },
      ...
      <header className="sticky top-0 z-[100] bg-white/95 backdrop-blur-sm border-b border-[#E5E7EB]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between relative z-50 gap-4">
          ...
          <div className="hidden lg:flex flex-1 justify-center min-w-0">
            <nav
              ref={desktopNavRef}
              className="relative flex items-center justify-center gap-1 text-sm font-medium text-[#64748B]"
            >
              {navGroups.map((group) => {
                                ...
                                >
                                  <div
                                    className={`mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border transition-colors ${
                                      isActive
                                        ? 'border-blue-200 bg-[#1E40AF] text-white'
                                        : 'border-slate-200 bg-slate-50 text-[#1E40AF] group-hover:bg-white'
                                    }`}
                                  >
                                    {Icon ? (
                                      <Icon className="h-4 w-4" />
      ...
      >
        <div className="flex min-h-full flex-col gap-4 px-4 py-5">
          {navGroups.map((group) => (
            <div
              key={group.key}
              className="overflow-hidden rounded-2xl border border-[#E5E7EB] bg-slate-50/70"
            >
              <button
                type="button"
